...
class BlogPost(models.Model):
    ...
    meta_description = models.TextField(blank=True, null=True,
                                        help_text="توضیحات متا (Meta Description)")  # توضیحات برای SEO
    meta_keywords = models.ManyToManyField(Keyword, blank=True,
                                           help_text="کلمات کلیدی (Keywords)")  # کلمات کلیدی برای SEO
